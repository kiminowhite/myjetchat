...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final Emoji2LibraryAccessors laccForEmoji2LibraryAccessors = new Emoji2LibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at emoji2
     */
    public Emoji2LibraryAccessors getEmoji2() {
        return laccForEmoji2LibraryAccessors;
    }
    ...
    public static class Emoji2LibraryAccessors extends SubDependencyFactory {

        public Emoji2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for emojipicker (androidx.emoji2:emoji2-emojipicker)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getEmojipicker() {
                return create("emoji2.emojipicker");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: emoji2Emojipicker (1.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getEmoji2Emojipicker() { return getVersion("emoji2Emojipicker"); }
