...
public class EmojiAndStickerFragment extends Fragment implements EmojiAdapter.OnEmojiClickListener,StickerAdpter.OnStickerClickListener {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // 创建并返回对话框的视图
        View view = inflater.inflate(R.layout.emojiandstick_bottom_fragement, container, false);
